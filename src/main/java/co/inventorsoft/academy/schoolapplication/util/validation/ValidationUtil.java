package co.inventorsoft.academy.schoolapplication.util.validation;
...
import static co.inventorsoft.academy.schoolapplication.util.constant.ValidationPatterns.VALIDATION_PATTERN_EMAIL;
